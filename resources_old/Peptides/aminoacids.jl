...
reslib["BKX"] = Residue(
    "BKX",
    [
        Atom(name= "H", symbol="H",  x=0.3909, y=0.0724, z=0.0000),
        Atom(name= "N", symbol="N",  x=0.3326, y=0.1548, z=0.0000),
        Atom(name="CA", symbol="C",  x=0.3970, y=0.2846, z=0.0000),
        Atom(name= "C", symbol="C",  x=0.5486, y=0.2705, z=0.0000),
        Atom(name= "O", symbol="O",  x=0.6009, y=0.1593, z=0.0000)
    ],
    ConnectGraphByName(
        "H"  => ["N"],
        "N"  => ["H", "CA"],
