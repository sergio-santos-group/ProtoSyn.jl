...
const n_inner_steps            = 10000  # Number of steps on each inner cycle;
const n_outer_steps            = 100    # Number of inner cycles to perform;
const init_min_n_steps         = 10000  # Number of steps for Steepest Descent minimization (initial long minimization);
const min_n_steps              = 5000   # Number of steps for Steepest Descent minimization (every step of inner cycle);
...
# 6. Define the system (Initial) temperature:
...
# 7. Define the target acceptance ratio and buffer zone:
