...
const n_loop_closer_steps      = 300    # Number of steps for Steepest Descent in loop closure (After Blockrot movements in Monte Carlo Refinement);
...
const soft_br_step_s           = π/10   # Step size for blockrot movements in the Monte Carlo Refinement;
const soft_br_tr_step_s        = 0.02   # Step size for translation in blockrot movements;

# Mutators probabilities:
const soft_dh_p_mut            = 0.020  # Mutation probability for dihedral movements in the Monte Carlo Refinement;
...
const soft_cs_p_mut            = 0.01  # Mutation probability for crankshaft movements in the Monte Carlo Refinement;
...
const soft_br_p_mut            = 0.20   # Mutation probability for blockrot movements in the Monte Carlo Refinement;
...
const λ_eSol                   = 2000.0 # Scalar constant for solvation energy;
...
const contact_force_constant   = 0.0    # Force constant for contact distance FBRs;
