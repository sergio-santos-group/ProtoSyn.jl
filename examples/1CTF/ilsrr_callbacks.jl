...
print_structure = @Common.callback print_str_every_ic function cb_print_inner(step::Int64, st::Common.State, dr::Drivers.AbstractDriver, args...)
...
reset_temperature = @Common.callback 1 function cb_adjust_temperature(step::Int64, st::Common.State, dr::Drivers.ILSRR.Driver, args...)
