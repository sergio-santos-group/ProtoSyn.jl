...
print_status = @Common.callback 100 function cb_status(step::Int64, st::Common.State, dr::Drivers.SteepestDescent.Driver, max_force::Float64, gamma::Float64, args...)
...
print_structure = @Common.callback 100 function cb_structure(step::Int64, st::Common.State, dr::Drivers.SteepestDescent.Driver, args...)
...
println("Performed $r_count blockrot movements")
Print.as_pdb(xyz_destination, state, metadata)