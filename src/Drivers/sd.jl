...
# SteepestDescent{T}(eval!::Union{Function, EnergyFunction}, max_steps::Int) where {T <: AbstractFloat} = begin
#     return SteepestDescent{T}(eval!, max_steps, T(1), T(0.1))
# end
...
#------------------------------------------------
function (driver::SteepestDescent{T})(cb::Opt{F}, pose::Pose) where {T, F <: Function}
...
(driver::SteepestDescent)(pose::Pose) = driver(nothing, pose)
